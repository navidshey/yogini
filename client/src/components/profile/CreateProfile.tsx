...
interface mapDispatch {
  createProfile: (userData: State, history: any) => any;
}
...
class CreateProfile extends Component<Prop, State & any> {
...
(CreateProfile as any).propTypes = {
...
export default connect(mapStateTProps, { createProfile })(
